const defaultBiomarkers = [
  {
    name: "Hemoglobin",
    aliases: ["Hb", "Hgb", "Haemoglobin", "Hemoglobin Level", "Total Hemoglobin"],
    unit: "g/dL",
    category: "blood",
    ranges: { normalMin: 13.0, normalMax: 17.0 },
    thresholds: { low: 13.0, high: 17.0 },
    weight: 0.9,
    recommendations: {
      low: {
        immediate: ["Consult a doctor for anemia screening and dietary iron evaluation."],
        daily: [
      ...
      high: {
        immediate: ["Stay well hydrated and consult a physician to evaluate elevated hemoglobin."],
        daily: [
  ...
  },
  {
    ...
    aliases: ["WBC", "White Cell Count", "Total WBC", "WBC Count", "Leukocytes"],
    unit: "/µL",
    category: "blood",
    ...
    recommendations: {
      low: {
        immediate: ["Avoid close contact with sick individuals and seek medical evaluation."],
        daily: [
      ...
      high: {
        immediate: ["Check for signs of infection or inflammation and consult your doctor."],
        daily: [
  ...
  },
  {
    ...
    aliases: ["RBC", "Red Cell Count", "Total RBC", "RBC Count", "Erythrocytes"],
    unit: "million/µL",
    category: "blood",
    ranges: { normalMin: 4.5, normalMax: 5.9 },
    thresholds: { low: 4.5, high: 5.9 },
    weight: 0.8,
    recommendations: {
      low: {
        immediate: ["Consult a doctor to check B12, folate, and iron levels."],
        daily: [
      ...
      high: {
        immediate: ["Consult a healthcare provider and increase fluid intake."],
        daily: [
  ...
  {
    name: "Platelet Count",
    aliases: ["PLT", "Platelets", "Total Platelets", "Thrombocytes", "Platelet"],
    unit: "/µL",
    category: "blood",
    ranges: { normalMin: 150000, normalMax: 450000 },
    thresholds: { low: 150000, high: 450000 },
    weight: 0.8,
    recommendations: {
      low: {
        immediate: ["Avoid activities with high risk of injury or bruising and consult a physician."],
        daily: [
      ...
      high: {
        immediate: ["Consult a physician to investigate potential underlying inflammation or iron deficiency."],
        daily: [
  ...
  },
  {
    ...
    unit: "%",
    category: "blood",
    ranges: { normalMin: 40.0, normalMax: 50.0 },
    thresholds: { low: 40.0, high: 50.0 },
    weight: 0.7,
    recommendations: {
      low: {
        immediate: ["Discuss iron and nutritional intake with your healthcare provider."],
        daily: [
      ...
      high: {
        immediate: ["Increase water intake immediately and consult a doctor."],
        daily: [
  ...
  {
    name: "MCV",
    aliases: ["Mean Corpuscular Volume", "MCV Level"],
    unit: "fL",
    category: "blood",
    ranges: { normalMin: 80.0, normalMax: 100.0 },
    thresholds: { low: 80.0, high: 100.0 },
    weight: 0.6,
    recommendations: {
      low: {
        immediate: ["Get screened for iron deficiency anemia by your doctor."],
        daily: [
      ...
      high: {
        immediate: ["Check Vitamin B12 and Folate levels with your doctor."],
        daily: [
  ...
  {
    name: "MCH",
    aliases: ["Mean Corpuscular Hemoglobin", "MCH Level", "Mean Corpuscular Haemoglobin"],
    unit: "pg",
    category: "blood",
    ranges: { normalMin: 27.0, normalMax: 33.0 },
    thresholds: { low: 27.0, high: 33.0 },
    weight: 0.6,
    recommendations: {
      low: {
        immediate: ["Review iron intake and consult a healthcare provider."],
        daily: [
      ...
      high: {
        immediate: ["Consult a physician for a B-vitamin and folate evaluation."],
        daily: [
  ...
  {
    name: "MCHC",
    aliases: ["Mean Corpuscular Hemoglobin Concentration", "MCHC Level"],
    unit: "g/dL",
    category: "blood",
    ranges: { normalMin: 32.0, normalMax: 36.0 },
    thresholds: { low: 32.0, high: 36.0 },
    weight: 0.6,
    recommendations: {
      low: {
        immediate: ["Consult a physician for a complete iron profile check."],
        daily: [
      ...
      high: {
        immediate: ["Stay well hydrated and discuss results with your healthcare provider."],
        daily: [
  ...
  },
  {
    ...
    aliases: ["FBS", "Fasting Blood Glucose", "FBG", "Blood Sugar Fasting", "Glucose Fasting", "Fasting Glucose", "Blood Glucose"],
    unit: "mg/dL",
    category: "blood",
    ranges: { normalMin: 70.0, normalMax: 100.0 },
    thresholds: { low: 70.0, high: 100.0 },
    weight: 1.0,
    recommendations: {
      low: {
        immediate: ["Consume a fast-acting carbohydrate like fruit juice or glucose tablets if feeling dizzy or shaky."],
        daily: [
      ...
      high: {
        immediate: ["Consult a physician for HbA1c testing and metabolic evaluation."],
        daily: [
  ...
  },
  {
    ...
    aliases: ["Cholesterol Total", "Serum Total Cholesterol", "TC", "Cholesterol"],
    unit: "mg/dL",
    category: "blood",
    ranges: { normalMin: 120.0, normalMax: 200.0 },
    thresholds: { low: 120.0, high: 200.0 },
    weight: 0.9,
    recommendations: {
      low: {
        immediate: ["Discuss lipid levels with your physician during routine checkups."],
        daily: [
      ...
      high: {
        immediate: ["Consult a doctor for a full cardiovascular risk assessment and dietary guidance."],
        daily: [
  ...
  },
  {
    ...
    aliases: ["LDL", "LDL-C", "Low Density Lipoprotein", "Bad Cholesterol", "LDL Level"],
    unit: "mg/dL",
    category: "blood",
    ranges: { normalMin: 50.0, normalMax: 100.0 },
    thresholds: { low: 50.0, high: 100.0 },
    weight: 0.9,
    recommendations: {
      low: {
        immediate: ["No action needed; continue healthy lifestyle habits."],
        daily: [
      ...
      high: {
        immediate: ["Consult your healthcare provider to discuss heart-healthy dietary changes or lipid management."],
        daily: [
  ...
  },
  {
    ...
    aliases: ["HDL", "HDL-C", "High Density Lipoprotein", "Good Cholesterol", "HDL Level"],
    unit: "mg/dL",
    category: "blood",
    ranges: { normalMin: 40.0, normalMax: 80.0 },
    thresholds: { low: 40.0, high: 80.0 },
    weight: 0.9,
    recommendations: {
      low: {
        immediate: ["Discuss strategies to raise HDL with your healthcare provider."],
        daily: [
      ...
      high: {
        immediate: ["No medical intervention needed; excellent heart protection."],
        daily: [
  ...
  {
    name: "Triglycerides",
    aliases: ["TG", "Trigs", "Serum Triglycerides", "Triglyceride Level", "Triglyceride"],
    unit: "mg/dL",
    category: "blood",
    ranges: { normalMin: 50.0, normalMax: 150.0 },
    thresholds: { low: 50.0, high: 150.0 },
    weight: 0.8,
    recommendations: {
      low: {
        immediate: ["No action required; maintain balanced nutrition."],
        daily: [
      ...
      high: {
        immediate: ["Consult a physician for metabolic evaluation and dietary adjustments."],
        daily: [
  ...
  {
    name: "Vitamin D",
    aliases: ["25-OH Vitamin D", "Vitamin D3", "Serum Vitamin D", "25-Hydroxyvitamin D", "Vit D"],
    unit: "ng/mL",
    category: "vitamin",
    ranges: { normalMin: 30.0, normalMax: 100.0 },
    thresholds: { low: 30.0, high: 100.0 },
    weight: 0.8,
    recommendations: {
      low: {
        immediate: ["Consult a physician regarding Vitamin D3 supplementation."],
        daily: [
      ...
      high: {
        immediate: ["Pause Vitamin D supplements and consult a doctor."],
        daily: [
  ...
  {
    name: "Vitamin B12",
    aliases: ["B12", "Serum B12", "Cobalamin", "Vitamin B-12", "Vit B12"],
    unit: "pg/mL",
    category: "vitamin",
    ranges: { normalMin: 300.0, normalMax: 900.0 },
    thresholds: { low: 300.0, high: 900.0 },
    weight: 0.7,
    recommendations: {
      low: {
        immediate: ["Consult a doctor about B12 supplementation or injections."],
        daily: [
      ...
      high: {
        immediate: ["Review dietary supplements containing B12 with your doctor."],
        daily: [
          "Stay well hydrated.",
          "Maintain a balanced whole-food diet."
        ]
  ...
  {
    name: "TSH",
    aliases: ["Thyroid Stimulating Hormone", "Serum TSH", "Thyrotropin"],
    unit: "mIU/L",
    category: "hormone",
    ...
    recommendations: {
      low: {
        immediate: ["Schedule a comprehensive thyroid panel (Free T3/T4) with your physician."],
        daily: [
      ...
      high: {
        immediate: ["Consult an endocrinologist or physician for thyroid evaluation and support."],
        daily: [
  ...
  {
    name: "Creatinine",
    aliases: ["Serum Creatinine", "Creat", "Cr", "Blood Creatinine"],
    unit: "mg/dL",
    category: "blood",
    ranges: { normalMin: 0.6, normalMax: 1.2 },
    thresholds: { low: 0.6, high: 1.2 },
    weight: 0.9,
    recommendations: {
      low: {
        immediate: ["No urgent action required; discuss during routine checkup."],
        daily: [
      ...
      high: {
        immediate: ["Increase water intake and consult a doctor immediately for kidney evaluation."],
        daily: [
  ...
  {
    name: "ALT",
    aliases: ["SGPT", "Alanine Aminotransferase", "Serum ALT", "ALT/SGPT"],
    unit: "U/L",
    category: "blood",
    ranges: { normalMin: 7.0, normalMax: 56.0 },
    thresholds: { low: 7.0, high: 56.0 },
    weight: 0.8,
    recommendations: {
      low: {
        immediate: ["No action required."],
        daily: ["Maintain a healthy lifestyle and balanced nutrition."]
      },
      high: {
        immediate: ["Consult a physician for a liver function evaluation."],
        daily: [
  ...
  {
    name: "AST",
    aliases: ["SGOT", "Aspartate Aminotransferase", "Serum AST", "AST/SGOT"],
    unit: "U/L",
    category: "blood",
    ranges: { normalMin: 10.0, normalMax: 40.0 },
    thresholds: { low: 10.0, high: 40.0 },
    weight: 0.8,
    recommendations: {
      low: {
        immediate: ["No action required."],
        daily: ["Maintain healthy daily habits."]
      },
      high: {
        immediate: ["Consult your doctor for further enzyme evaluation."],
        daily: [
