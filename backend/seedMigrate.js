...
const run = async () => {
  ...
  const doctor = await User.create({
    ...
    password: hashedPw, role: 'doctor', mobile: '0771234567',
    gender: 'Female', city: 'Colombo', dob: new Date('1990-01-01'),
  });
  ...
  const patients = await User.insertMany([
    { name: 'Priyanka Jayawardhana', email: 'patient1@test.com', password: hashedPw, role: 'patient', mobile: '0771111111', gender: 'Female', city: 'Colombo', dob: new Date('1997-03-14') },
    { name: 'Ravindra Perera',       email: 'patient2@test.com', password: hashedPw, role: 'patient', mobile: '0772222222', gender: 'Male', city: 'Kandy', dob: new Date('1990-07-22') },
    { name: 'Kavindi Gunawardana',   email: 'patient3@test.com', password: hashedPw, role: 'patient', mobile: '0773333333', gender: 'Female', city: 'Galle', dob: new Date('2003-11-02') },
    { name: 'Sudarshana Jayakodi',   email: 'patient4@test.com', password: hashedPw, role: 'patient', mobile: '0774444444', gender: 'Male', city: 'Negombo', dob: new Date('1994-05-09') },
  ]);
